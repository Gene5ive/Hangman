defmodule GameTest do
  ...
  test "first occuranece of letter is not already used" do
    game = Game.new_game()
    game = Game.make_move(game, "x")
    assert game.game_state != :already_used
  end

  test "second occuranece of letter is already used" do
    game = Game.new_game()
    game = Game.make_move(game, "x")
    assert game.game_state != :already_used
    game = Game.make_move(game, "x")
  ...
  test "Guess is a single lower-case ASCII character" do
    game = Game.new_game("wibble")
    assert Game.make_move(game, "X") == "Must be lowercase"
  end
